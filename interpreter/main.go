// The objective of the interpreter is to interprete an input and transform it according with the needs
// This is done in 2 parts: Lexing and Parsing
// Lexing turns the input into a set of tokens
// Parsing turns the tokens into meaningfull data
